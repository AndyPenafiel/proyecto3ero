...
<html lang="en">
	...
	<head><base href=""/>
		...
		<link rel="shortcut icon" href="assets/media/misc/andy.png" />
					...
					<div class="d-flex align-items-center flex-stack flex-grow-1">
						<div class="app-header-logo d-flex align-items-center flex-stack px-lg-11 mb-2" id="kt_app_header_logo">
							...
							<a href="../dist/index.html" class="app-sidebar-logo">
								<img alt="Logo" src="assets/media/logos/default.png" class="h-30px theme-light-show" />
                                <img alt="Logo" src="assets/media/logos/default2.png" class="h-30px theme-dark-show" />
							</a>
							<!--end::Logo-->
