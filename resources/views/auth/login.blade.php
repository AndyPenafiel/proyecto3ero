...
<html lang="en">
	...
	<body id="kt_body" class="app-blank">
        ...
        <div class="text-center mb-10">
									...
									<a href="../dist/authentication/sign-up/basic.html" class="link-primary fw-bold">Crea una cuenta</a></div>
									<!--end::Link-->
								</div>
        <div>
        <label class="form-label fs-6 fw-bold text-dark">Usuario</label>
            <x-text-input id="name" class="form-control form-control-lg form-control-solid" type="text" name="name" :value="old('name')" required autofocus autocomplete="username" />
        ...
        <div class="d-flex flex-stack mb-2">
										...
										<!--end::Label-->
										<!--begin::Link-->
										<a href="../dist/authentication/sign-in/password-reset.html" class="link-primary fs-6 fw-bold">¿Olvidaste la contraseña?</a>
										<!--end::Link-->
									</div>
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <x-primary-button class="btn btn-lg btn-primary w-100 mb-5">
                {{ __('Ingresar') }}
            </x-primary-button>
            ...
            <span class="indicator-progress">Espera un momento...
									...
									<img alt="Logo" src="{{asset('assets/media/svg/brand-logos/google-icon.svg')}}" class="h-20px me-3" />Continuar con Google</a>
									<!--end::Google link-->
									<!--begin::Google link-->
									<a href="#" class="btn btn-flex flex-center btn-light btn-lg w-100 mb-5">
									<img alt="Logo" src="{{asset('assets/media/svg/brand-logos/facebook-4.svg')}}" class="h-20px me-3" />Continuar con Facebook</a>
									<!--end::Google link-->
									<!--begin::Google link-->
									<a href="#" class="btn btn-flex flex-center btn-light btn-lg w-100">
									<img alt="Logo" src="{{asset('assets/media/svg/brand-logos/apple-black.svg')}}" class="theme-light-show h-20px me-3" />
									<img alt="Logo" src="{{asset('assets/media/svg/brand-logos/apple-black-dark.svg')}}" class="theme-dark-show h-20px me-3" />Continuar con Apple</a>
									<!--end::Google link-->
        </div>
    </form>
							<!--end::Form-->
